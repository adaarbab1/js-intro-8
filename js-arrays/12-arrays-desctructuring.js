...
// Instead of above 3 lines, you can destructuring array feature as below
...
const credentials = ['jondoe', 'johndoe@gmail.com', 'Test1234$'];
const [, email, password] = credentials;
console.log (email);
console.log (password);

if (password !== 'Test123$') console.log ('The password does not match');
